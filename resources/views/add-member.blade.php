...
<head>
    ...
    <title>Gym Management - Add Member</title>
        ...
        <div class="row">
            ...
            <form action="/store" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" id="email" name="email" placeholder="e.g. jdelacruz@example.com">
                </div>
                <div class="mb-3">
                    <label for="age" class="form-label">Membership Expiration:</label>
                    <input type="date" class="form-control" id="membership_expiration" name="membership_expiration" placeholder="e.g. December 31, 2023">
                </div>
                <br>
                <hr>
                <br>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="trainer_id" name="trainer_id" placeholder="e.g. 1">
                </div>
