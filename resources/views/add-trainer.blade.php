...
<body>
    ...
    <div class="container p-5 m-5">
        <div class="row">
            ...
            <hr />
            <form action="/store_trainer" method="POST">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="specialization" name="specialization" placeholder="e.g. Chiropractor">
                </div>
                <div class="mb-3">
                    <label for="phone" class="form-label">Phone:</label>
                    <input type="text" class="form-control" id="phone" name="phone" placeholder="e.g. 09191234567">
                </div>
