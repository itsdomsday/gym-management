...
<body>
    ...
    <div class="container p-5 m-5">
        <div class="row">
            ...
            @endif
            <hr />
            <form action="/create-trainer" method="GET">
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="{{ route('edit_trainer', $trainer->id) }}">Edit</a></li>
                                    <li><a class="dropdown-item" href="{{ route('delete_trainer', $trainer->id) }}">Delete</a></li>
                                </ul>
                            </div>
